...
def Gaussian_UnEnt(params:tuple)-> callable:
    ...
    is controlled by the parameters Omega1 and Omega2. The timing correlation is captured by the Mu1 parameter, which 
    acts as the central time for both photons.
    ...
    params : tuple of floats
        ...
        - Mu1 (float): Central time parameter associated with the joint photon pair profile.
    ...
    .. math::
        profile(t1, t2) = \sqrt{\frac{\Omega_1 \cdot \Omega_2}{2\pi}} \cdot 
                          ...
                          \exp\left(-\frac{\Omega_2^2 \cdot (t2 - \mu_1)^2}{4}\right)
    ...
    - The Mu1 parameter adjusts the central time correlation for both photons.
    """
